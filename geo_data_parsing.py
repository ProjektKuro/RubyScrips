...
with open('export.geojson') as file:
    ...
    for shop in shop_data['features']:
        ...
        if (shop_type == 'Point'):
            shop_lat = shop['geometry']['coordinates'][0]
            shop_lon = shop['geometry']['coordinates'][1]
        elif(shop_type == 'LineString'):
            shop_lat = shop['geometry']['coordinates'][0][0]
            shop_lon = shop['geometry']['coordinates'][0][1]
        elif(shop_type == 'Polygon'):
            shop_lat = shop['geometry']['coordinates'][0][0][0]
            shop_lon = shop['geometry']['coordinates'][0][1][1]
        elif(shop_type == 'MultiPolygon'):
            shop_lat = shop['geometry']['coordinates'][0][0][0][0]
            shop_lon = shop['geometry']['coordinates'][0][0][0][1]
        else:
        ...
        se = Shop(shop_name, shop_lat, shop_lon, sa)
